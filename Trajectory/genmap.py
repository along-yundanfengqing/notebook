...
if __name__ == "__main__":
    g = GenerateGoogleMap()
    colors = ['#FF0005', '#0000FF']
    files = ['Data/Uncompressed/originList.txt', 'Data/Compressed/compressList.txt']
    g.gen_googlemap(files, colors, 12, 39.9, 116.4, 'Data/trajectory.html')
